                ...
                <div className='descriptionTextBoxGoogleMaps'>
                    <div className='descriptionText'>
                        <p className='descriptionTextParagraph'>
                            Our 4-star hotel is located directly on the beach. It offers its guests breathtaking views of the sea and the beach. It has 70 rooms, all with balcony or terrace and sea view.
                        </p>
                        <p className='descriptionTextParagraph'>
                        ...
                        <p className='descriptionTextParagraph'>
                            The <span className='descriptionTextSpan '>Hotel Lamoure</span> is the ideal place for a relaxing beach vacation with family or friends.It has an excellent location near many attractions and activities.The staff is friendly and helpful, and is always available to make guests' stays as pleasant as possible.
                        </p>
                    </div>
